			...
			array(
				...
				'args'                => array(
					'q'              => array(
						'required'          => false,
						'type'              => 'string',
						'description'       => esc_html__( 'Search Query', 'aquila-features' ),
						'sanitize_callback' => 'sanitize_text_field',
					),
					'categories'     => array(
						'required'          => false,
						'type'              => 'string',
						'description'       => esc_html__( 'Categories', 'aquila-features' ),
						'sanitize_callback' => 'sanitize_text_field',
					),
					'tags'           => array(
						'required'          => false,
						'type'              => 'string',
						'description'       => esc_html__( 'Tags', 'aquila-features' ),
						'sanitize_callback' => 'sanitize_text_field',
					),
					'page_no'        => array(
						'required'          => false,
						'type'              => 'string',
						'description'       => esc_html__( 'Page no', 'aquila-features' ),
						'sanitize_callback' => 'sanitize_text_field',
					),
					'posts_per_page' => array(
						'required'          => false,
						'type'              => 'string',
						'description'       => esc_html__( 'Posts per page', 'aquila-features' ),
						'sanitize_callback' => 'sanitize_text_field',
					),
				),
			)
