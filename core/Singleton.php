...
abstract class Singleton {
	...
	public static function instance()
	{
		...
		if (! isset($instance[$called_class])) {
			...
			/**
			 * Dependent items can use the `aquila_features_singleton_init_{$called_class}` hook to execute code
			 */
			do_action(sprintf('aquila_features_singleton_init_%s', $called_class)); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
